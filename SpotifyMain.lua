...
RobloxNotification("Note:", "Press Delete to open/close UI", 5)

function Callback(answer)
    if answer == "Yes" then
        setclipboard("https://youtu.be/N34BM2CU_3g")
        RobloxNotification("Copied", "Please paste the video link to your google chrome", 3)
...
game.StarterGui:SetCore("SendNotification", {
    Title = "Get Spotify API Key Tutorial",
    Text = "Would you like to watch on how to get your own spotify api key?",
    Duration = 60,
    Button1 = "Yes",
    Button2 = "No",
    Callback = Bindable
...
local function GDDJ_fake_script() -- Spotify.LocalScript 
	...
	tokenmain.Description.Text = "1. Click Link in the top left and paste the link in your browser 2. Click GET TOKEN and select the following: user-read-currently-playing user-read-playback-state user-modify-playback-state 3. After it refreshes, in the OAuth Token text box, select all and copy the token. Paste this token in the text box below and click Submit."
	...
	-- Functions
	local request = request or http_request or (syn and syn.request) or (http and http.request) or nil
	...
	tokenmain.Submit.Activated:Connect(function()
		...
		tokenmain.Input.Text = valid and "Your token is valid!" or "Your token is Invalid"
